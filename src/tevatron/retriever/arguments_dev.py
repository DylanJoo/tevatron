...
class DataArguments:
    ...
    # NOTE: change this to multiple dataset input
    # dataset_name: List[str] = field(
    #     default_factory=lambda: ['json'], 
    #     metadata={"help": "huggingface dataset name", "nargs": "+"}
    # )
    ...
    # NOTE: change this to multiple dataset split
    dataset_split: str = field(
        default='train', metadata={"help": "dataset split"}
    )
    # dataset_split: List[str] = field(
    #     default_factory=lambda: ['train'], 
    #     metadata={"help": "dataset split", "nargs": "+"}
    # )
    ...
    # NOTE: change this to multiple corpus input
    # corpus_name: List[str] = field(
    #     default_factory=lambda: [None], 
    #     metadata={"help": "huggingface dataset name for corpus", "nargs": "+"}
    # )
